...
```
*Intuitive explanation: Server-Side Request Forgery risks and mitigations.*

## 2. Why It Exists
This security control exists to prevent systemic failure modes in ssrf prevention. Without it, applications are vulnerable to server-side request forgery.
