...
```
*Intuitive explanation: Django CSRF internals, HMAC, TRUSTED_ORIGINS.*

## 2. Why It Exists
This security control exists to prevent systemic failure modes in csrf deep dive. Without it, applications are vulnerable to cross-site request forgery.
