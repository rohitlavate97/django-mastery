...
```
*Intuitive explanation: Template auto-escaping, safe filters, CSP.*

## 2. Why It Exists
This security control exists to prevent systemic failure modes in xss prevention. Without it, applications are vulnerable to cross-site scripting.
