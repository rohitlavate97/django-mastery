...
```
*Intuitive explanation: Cross-Origin Resource Sharing with django-cors-headers.*

## 2. Why It Exists
This security control exists to prevent systemic failure modes in cors configuration. Without it, applications are vulnerable to unauthorized cross-origin requests.
