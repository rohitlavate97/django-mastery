...
```
*Intuitive explanation: HSTS, CSP, X-Frame-Options, etc.*

## 2. Why It Exists
This security control exists to prevent systemic failure modes in secure headers. Without it, applications are vulnerable to clickjacking, MIME-sniffing, MITM.
