...
```
*Intuitive explanation: Environment variables, Vault, AWS Secrets Manager.*

## 2. Why It Exists
This security control exists to prevent systemic failure modes in secret management. Without it, applications are vulnerable to secret leaks.
