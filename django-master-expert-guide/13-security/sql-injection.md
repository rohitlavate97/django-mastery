...
```
*Intuitive explanation: ORM injection safety, raw queries, parameterization.*

## 2. Why It Exists
This security control exists to prevent systemic failure modes in sql injection. Without it, applications are vulnerable to database injection attacks.
