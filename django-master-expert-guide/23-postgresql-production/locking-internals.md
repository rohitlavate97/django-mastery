...
## Deep Dive Context
Exploring: PostgreSQL locking matrix: Row-level locks (`FOR UPDATE`, `FOR SHARE`, `FOR NO KEY UPDATE`), Table-level locks (`ACCESS SHARE` to `ACCESS EXCLUSIVE`), Advisory locks in Django.
