...
## Deep Dive Context
Exploring: PgBouncer deep dive: Session pooling vs Transaction pooling vs Statement pooling. Configuring Django with PgBouncer transaction pooling (`DISABLE_SERVER_SIDE_CURSORS = True`).
