...
## Deep Dive Context
Exploring: Reading `EXPLAIN (ANALYZE, BUFFERS, COSTS)` in detail: Seq Scan, Index Scan, Index Only Scan, Bitmap Scan, Nested Loop, Hash Join, Merge Join. Buffers read/hit.
