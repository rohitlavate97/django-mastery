...
```text
[ QUERY PLANS MENTAL MODEL & DATA FLOW ]
...
This section covers the core engineering problem solved by proper configuration and understanding of Query Plans.
...
### Incident Runbook & Deep Diagnostics: Query Plans

**🔴 SYMPTOM**: High error rates (500s, 502s) or massive latency degradation related to Query Plans.
...
**Q: How does Query Plans interact with transaction isolation levels?**
