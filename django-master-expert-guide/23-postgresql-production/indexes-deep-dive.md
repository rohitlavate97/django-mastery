...
## Deep Dive Context
Exploring: PostgreSQL Index types: B-tree, GIN (JSONField / ArrayField / Full-text search), GiST, BRIN (timestamp series), Hash. Composite indexes, partial indexes (`condition=Q(...)`), covering indexes (`include=['col']`).
