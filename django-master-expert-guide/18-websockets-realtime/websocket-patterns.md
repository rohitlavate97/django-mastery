...
## 1. Mental Model
```text
[ ASCII Diagram of WebSocket Patterns Architecture ]
+-------------+      +--------------+      +----------------+
...
## 2. Why It Exists
Solving the problem of Chat rooms. When traditional request-response is not enough, this architecture provides a persistent connection.
