...
## 1. Mental Model
```text
[ ASCII Diagram of Production WebSockets Architecture ]
+-------------+      +--------------+      +----------------+
...
## 2. Why It Exists
Solving the problem of Auth. When traditional request-response is not enough, this architecture provides a persistent connection.
