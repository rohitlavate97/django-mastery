...
## 1. Mental Model
```text
[ ASCII Diagram of Django Channels Architecture Architecture ]
+-------------+      +--------------+      +----------------+
...
## 2. Why It Exists
Solving the problem of ASGI interface. When traditional request-response is not enough, this architecture provides a persistent connection.
