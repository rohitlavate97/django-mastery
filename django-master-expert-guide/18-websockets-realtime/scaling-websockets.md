...
## 1. Mental Model
```text
[ ASCII Diagram of Scaling WebSockets Architecture ]
+-------------+      +--------------+      +----------------+
...
## 2. Why It Exists
Solving the problem of Horizontal scaling. When traditional request-response is not enough, this architecture provides a persistent connection.
