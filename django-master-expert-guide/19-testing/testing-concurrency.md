...
## 1. Mental Model
```text
[ ASCII Diagram of Testing Concurrency Architecture ]
+-------------+      +--------------+      +----------------+
...
## 2. Why It Exists
Solving the problem of Race conditions. When traditional request-response is not enough, this architecture provides a persistent connection.
