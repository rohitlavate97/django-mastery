...
## 1. Mental Model
```text
[ ASCII Diagram of Factory Patterns Architecture ]
+-------------+      +--------------+      +----------------+
...
## 2. Why It Exists
Solving the problem of factory_boy. When traditional request-response is not enough, this architecture provides a persistent connection.
