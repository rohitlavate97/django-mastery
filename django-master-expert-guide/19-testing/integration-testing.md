...
## 1. Mental Model
```text
[ ASCII Diagram of Integration Testing Architecture ]
+-------------+      +--------------+      +----------------+
...
## 2. Why It Exists
Solving the problem of DRF endpoints. When traditional request-response is not enough, this architecture provides a persistent connection.
