...
## 1. Mental Model
```text
[ ASCII Diagram of Flaky Tests Architecture ]
+-------------+      +--------------+      +----------------+
...
## 2. Why It Exists
Solving the problem of Time-dependent. When traditional request-response is not enough, this architecture provides a persistent connection.
