...
```text
[ ARCHITECTURE MODEL: FLAKY TESTS ]
    +--------------------------------------------------+
...
This section covers the core engineering problem solved by proper configuration and understanding of Flaky Tests.
...
### Incident Runbook & Deep Diagnostics: Flaky Tests

**🔴 SYMPTOM**: High error rates (500s, 502s) or massive latency degradation related to Flaky Tests.
...
**Q: How does Flaky Tests interact with transaction isolation levels?**
