...
## 1. Mental Model
```text
[ ASCII Diagram of Pytest Django Setup Architecture ]
+-------------+      +--------------+      +----------------+
...
## 2. Why It Exists
Solving the problem of pytest.ini. When traditional request-response is not enough, this architecture provides a persistent connection.
