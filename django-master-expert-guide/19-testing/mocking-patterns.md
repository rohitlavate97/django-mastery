...
## 1. Mental Model
```text
[ ASCII Diagram of Mocking Patterns Architecture ]
+-------------+      +--------------+      +----------------+
...
## 2. Why It Exists
Solving the problem of unittest.mock. When traditional request-response is not enough, this architecture provides a persistent connection.
