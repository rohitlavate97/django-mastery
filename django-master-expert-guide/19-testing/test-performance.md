...
## 1. Mental Model
```text
[ ASCII Diagram of Test Performance Architecture ]
+-------------+      +--------------+      +----------------+
...
## 2. Why It Exists
Solving the problem of Parallel execution. When traditional request-response is not enough, this architecture provides a persistent connection.
