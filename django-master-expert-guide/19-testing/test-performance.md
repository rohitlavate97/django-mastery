...
```text
[ ARCHITECTURE MODEL: TEST PERFORMANCE ]
    +--------------------------------------------------+
...
This section covers the core engineering problem solved by proper configuration and understanding of Test Performance.
...
### Incident Runbook & Deep Diagnostics: Test Performance

**🔴 SYMPTOM**: High error rates (500s, 502s) or massive latency degradation related to Test Performance.
...
**Q: How does Test Performance interact with transaction isolation levels?**
