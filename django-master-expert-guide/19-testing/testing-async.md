...
## 1. Mental Model
```text
[ ASCII Diagram of Testing Async Code Architecture ]
+-------------+      +--------------+      +----------------+
...
## 2. Why It Exists
Solving the problem of Async views. When traditional request-response is not enough, this architecture provides a persistent connection.
