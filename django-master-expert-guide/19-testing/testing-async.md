...
```text
[ ARCHITECTURE MODEL: TESTING ASYNC ]
    +--------------------------------------------------+
    | Django 6.1 (Py 3.12+) Application Server         |
    | Module: Testing Async                            |
    +--------------------------------------------------+
        |                 |                    |
...
This section covers the core engineering problem solved by proper configuration and understanding of Testing Async.
...
### Incident Runbook & Deep Diagnostics: Testing Async

**🔴 SYMPTOM**: High error rates (500s, 502s) or massive latency degradation related to Testing Async.
...
**Q: How does Testing Async interact with transaction isolation levels?**
