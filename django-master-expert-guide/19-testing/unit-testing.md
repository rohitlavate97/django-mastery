...
## 1. Mental Model
```text
[ ASCII Diagram of Unit Testing Architecture ]
+-------------+      +--------------+      +----------------+
...
## 2. Why It Exists
Solving the problem of Fast tests. When traditional request-response is not enough, this architecture provides a persistent connection.
