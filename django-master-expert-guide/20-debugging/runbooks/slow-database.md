...
```text
[ DEBUGGING & RESOLUTION TOPOLOGY: SLOW DATABASE ]
...
This section covers the core engineering problem solved by proper configuration and understanding of Slow Database.
...
### Incident Runbook & Deep Diagnostics: Slow Database

**🔴 SYMPTOM**: High error rates (500s, 502s) or massive latency degradation related to Slow Database.
...
**Q: How does Slow Database interact with transaction isolation levels?**
