...
```text
[ DEBUGGING & RESOLUTION TOPOLOGY: SLOW API ]
...
This section covers the core engineering problem solved by proper configuration and understanding of Slow Api.
...
### Incident Runbook & Deep Diagnostics: Slow Api

**🔴 SYMPTOM**: High error rates (500s, 502s) or massive latency degradation related to Slow Api.
...
**Q: How does Slow Api interact with transaction isolation levels?**
