...
```text
[ DEBUGGING & RESOLUTION TOPOLOGY: WORKER CRASH ]
...
This section covers the core engineering problem solved by proper configuration and understanding of Worker Crash.
...
### Incident Runbook & Deep Diagnostics: Worker Crash

**🔴 SYMPTOM**: High error rates (500s, 502s) or massive latency degradation related to Worker Crash.
...
**Q: How does Worker Crash interact with transaction isolation levels?**
